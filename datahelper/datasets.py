...
class Squirrel(InMemoryDataset):
    ...
    def process(self):
        if self.geom_gcn_preprocess:
            ...
            tmp_val_mask = torch.clone(val_mask)
            tmp_val_mask[:3700]=0
            data = Data(x=x, edge_index=edge_index, y=y, train_mask=train_mask + tmp_val_mask,
